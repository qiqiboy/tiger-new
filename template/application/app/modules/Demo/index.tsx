...
const Demo: React.FC<DemoProps> = ({ $formutil }) => {
    const [visible, setVisible] = useState(false);

    const handleClick = () => Toast.show('重新请求!');
    ...
    switch ($formutil.$params.transition) {
        case 'Zoom':
            Transition = Zoom;
            break;
        case 'Flow':
    ...
    return (
        <Form className="app-demo app-main" onSubmit={handleSubmit} noValidate>
            <Card className="mb-3">
                <Card.Body>
                ...
                <Card.Body>
                    ...
                    <FormGroup name="demo2.switch" required className="mb-2">
                        <SwitchGroup>
                            ...
                            <Form.Check disabled value="2" type="switch" label="disabled switch" id="demo2.switch.2" />
                        </SwitchGroup>
                    </FormGroup>
            ...
            <Transition in={visible} direction={direction}>
                <div>
                    <h1>这里将被动画处理</h1>
                    <p>
                        默认提供了四种动画效果：<code>Fade</code> <code>Zoom</code> <code>Flow</code> <code>Flip</code>{' '}
                        <code>Collapse</code>
                    </p>
                </div>
            </Transition>
            ...
            <h3>Debug</h3>
            <Debug data={$formutil.$params} />
        </Form>
    );
};

export default withForm(Demo);
