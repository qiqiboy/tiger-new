    ...
    render() {
        return (
            <div className="form">
                ...
                <Field name="content" type="textarea" rows="5" placeholder="您的问题" required validMessage={{required: '请输入内容'}} />
                <button onClick={this.submit} disabled={this.props.easyform.$invalid ? true : false}>提交</button>
